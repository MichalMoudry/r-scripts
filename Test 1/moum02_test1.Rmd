...
```
`Slovní interpretace`: Variační koeficient se používá pro porovnání variablity mezi dvěmi datasety, je tedy .
...
### a)
q ... horní hodnota rozmezí ()

 = 13mean ... střední hodnota

 = 10sd = směrodatná odchylka
` = 2``{r}
